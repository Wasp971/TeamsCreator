...
setup(name='TeamsCreator', version='1.0', packages=['venv.Lib.site-packages.pip', 'venv.Lib.site-packages.pip._vendor',
													...
													'venv.Lib.site-packages.numpy.testing.nose_tools',
													...
													'venv.Lib.site-packages.aiohttp', 'venv.Lib.site-packages.chardet',
													'venv.Lib.site-packages.chardet.cli',
													'venv.Lib.site-packages.discord',
													'venv.Lib.site-packages.discord.ext',
													'venv.Lib.site-packages.discord.ext.ipc',
													'venv.Lib.site-packages.discord.ext.commands',
													'venv.Lib.site-packages.multidict',
													'venv.Lib.site-packages.websockets',
													'venv.Lib.site-packages.websockets.py35',
													'venv.Lib.site-packages.async_timeout',
	  ...
	  url='', license='', author='Wasp97', author_email='', description='', install_requires=['discord', 'numpy'])
